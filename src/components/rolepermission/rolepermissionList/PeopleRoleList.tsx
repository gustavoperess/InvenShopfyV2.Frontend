...
const PeopleRoleList = ({permissionsByEntity, onPermissionsChange}: {permissionsByEntity: any; onPermissionsChange: (updatedStates: ChildCheckboxStates) => void}) => {
    ...
    return (
        <div className="inventual-role-list border-b border-solid border-border flex items-center">
            ...
            <div className="inventual-role-right w-full border-s border-solid border-border">
                {DEFAULT_PEOPLE_PERMISSIONS.map((entity: any, index: number) => (
                    <div
                        key={index}
