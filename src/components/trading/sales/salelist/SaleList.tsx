...
const SaleList = () => {
  ...
  const filteredData = salesData?.data.filter((item: any) =>
    ...
    item.saleDate.toLowerCase().includes(searchQuery.toLowerCase()) ||
    item.saleStatus.toLowerCase().includes(searchQuery.toLowerCase()) ||
    item.totalAmount.toString().toLowerCase().includes(searchQuery.toLowerCase()) ||
    item.totalQuantitySold.toString().toLowerCase().includes(searchQuery.toLowerCase()) ||
