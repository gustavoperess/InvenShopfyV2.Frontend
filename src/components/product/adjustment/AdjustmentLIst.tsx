  ...
  return (
    <>
      <div className="invenShopfy-content-area px-4 sm:px-7">
        <div className="invenShopfy-adjustment-area bg-white p-5 sm:p-7 custom-shadow rounded-8 mt-7">
          <div className="invenShopfy-product-top-btn flex flex-wrap gap-5 mb-7">
            <Link className='invenShopfy-btn secondary-btn' href="/product/addadjustment"><span><i className="fa-regular fa-circle-plus"></i></span>Add Adjustment</Link>
          </div>
            ...
            <div className="grid grid-cols-12 gap-x-5 gap-y-4 mb-7 pb-0.5">
              ...
              <div className="col-span-12 md:col-span-5 lg:col-span-5 xl:col-span-7">
                <div className="invenShopfy-action-btn-wrapper md:justify-end">
                  ...
                  <button type="button" className="invenShopfy-action-btn warning-btn">
                  ...
                  <button type="button" className="invenShopfy-action-btn secondary-btn">
                  ...
                  <button type="button" className="invenShopfy-action-btn">
