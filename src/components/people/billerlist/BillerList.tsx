  ...
  return (
    ...
    <>
      <div className="invenShopfy-content-area px-4 sm:px-7">
        <div className="invenShopfy-addbiller-area bg-white p-5 sm:p-7 custom-shadow rounded-8 mt-7">
          <div className="invenShopfy-product-top-btn flex flex-wrap gap-5 mb-7">
            <Link className='invenShopfy-btn secondary-btn' href="/people/addbiller"><span><i className="fa-regular fa-circle-plus"></i></span>Add Biller</Link>
