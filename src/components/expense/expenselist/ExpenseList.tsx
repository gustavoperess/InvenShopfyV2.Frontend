...
const ExpenseList = () => {
  ...
  const filteredData = expenseData?.data.filter((item: any) =>
    ...
    item.expenseNote.toLowerCase().includes(searchQuery.toLowerCase()) ||
    item.expenseDescription.toLowerCase().includes(searchQuery.toLowerCase()) ||
    item.expenseStatus.toLowerCase().includes(searchQuery.toLowerCase()) ||
      ...
      <div className="invenShopfy-content-area px-4 sm:px-7">
        <div className="invenShopfy-report-area bg-white p-5 sm:p-7 custom-shadow rounded-8 mt-7">
          <div className="invenShopfy-product-top-btn flex flex-wrap gap-5 mb-7">
            <Link className='invenShopfy-btn secondary-btn' href="/expense/addexpense"><span><i className="fa-regular fa-circle-plus"></i></span>Add Expense</Link>
            <div className="file-import-btn-wrapper">
              <Link className='invenShopfy-btn primary-btn' href="/report/expensereport"><span><i className="fa-regular fa-file-chart-column"></i></span>Expense Report</Link>
            </div>
          </div>
