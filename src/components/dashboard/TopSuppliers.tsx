...
const TopSuppliers = () => {
    ...
    return (
        <>
            <div className=" custom-boxshadow invenShopfy-dashboard-topseller-wrapper p-5 sm:p-7 bg-white rounded-8 mb-5">
                        ...
                        <tbody>
                            {isLoading ? (
                                ...
                                supplierData?.data?.map((item: any, index: number) => <tr key={index}>
                                    <td>{item.id}</td>
                                    <td>
                                        <div className="invenShopfy-dashboard-supplier-list-name">
