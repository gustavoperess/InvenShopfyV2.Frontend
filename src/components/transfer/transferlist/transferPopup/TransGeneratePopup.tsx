                        ...
                        <div className='invenShopfy-common-modal-width width-full'>
                            <form onSubmit={dummyData}>
                                <div className="invenShopfy-invoice-popup-area">
                                    ...
                                    <div className="invenShopfy-invoice-popup-heading mb-11">
                                    ...
                                    <div className="invenShopfy-invoice-popup-address-area flex justify-between flex-wrap mb-9 pb-0.5 gap-y-7">
                                        <div className="invenShopfy-invoice-popup-address">
                                    ...
                                    <div className="invenShopfy-invoice-table-area">
                                        <div className="invenShopfy-invoice-table-inner border border-solid border-gray-borderThree border-b-0">
                                            <div className="invenShopfy-invoice-table-inner-wrapper">
                                                <div className="invenShopfy-invoice-table-list h-12 bg-gray-bg">
                                                    <div className="invenShopfy-invoice-table-sl border-e border-solid border-gray-borderThree">
                                                        <h5>SL</h5>
                                                    </div>
                                                    <div className="invenShopfy-invoice-table-product border-e border-solid border-gray-borderThree">
                                                        <h5>Products</h5>
                                                    </div>
                                                    <div className="invenShopfy-invoice-table-batch border-e border-solid border-gray-borderThree">
                                                        <h5>Batch No</h5>
                                                    </div>
                                                    <div className="invenShopfy-invoice-table-unit border-e border-solid border-gray-borderThree">
                                                        <h5>Unit</h5>
                                                    </div>
                                                    <div className="invenShopfy-invoice-table-price border-e border-solid border-gray-borderThree">
                                                        <h5>Unit Price</h5>
                                                    </div>
                                                    <div className="invenShopfy-invoice-table-qty border-e border-solid border-gray-borderThree">
                                                        <h5>Qty</h5>
                                                    </div>
                                                    <div className="invenShopfy-invoice-table-tax border-e border-solid border-gray-borderThree">
                                                        <h5>Tax</h5>
                                                    </div>
                                                    <div className="invenShopfy-invoice-table-discount border-e border-solid border-gray-borderThree">
                                                        <h5>Discount</h5>
                                                    </div>
                                                    <div className="invenShopfy-invoice-table-total">
                                                        <h5>Sub Total</h5>
                                                    </div>
                                                </div>
                                                <div className="invenShopfy-invoice-table-list custom-height-70">
                                                    <div className="invenShopfy-invoice-table-sl border-e border-solid border-gray-borderThree">
                                                        <span>01</span>
                                                    </div>
                                                    <div className="invenShopfy-invoice-table-product border-e border-solid border-gray-borderThree">
                                                ...
                                                <div className="invenShopfy-invoice-table-list h-10">
                                                    <div className="invenShopfy-invoice-table-sll">
                                                        <h5>Total =</h5>
                                                    </div>
                                                    <div className="invenShopfy-invoice-table-batch"></div>
                                                    <div className="invenShopfy-invoice-table-unit"></div>
                                                    <div className="invenShopfy-invoice-table-price"></div>
                                                    <div className="invenShopfy-invoice-table-qty"></div>
                                                    <div className="invenShopfy-invoice-table-tax border-s border-solid border-gray-borderThree">
                                                        <h5>8.00</h5>
                                                    </div>
                                                    <div className="invenShopfy-invoice-table-discount border-s border-solid border-gray-borderThree">
                                                        <h5>10.00</h5>
                                                    </div>
                                                    <div className="invenShopfy-invoice-table-total border-s border-solid border-gray-borderThree">
                                                        <h5>93.00</h5>
                                                    </div>
                                                </div>
                                                <div className="invenShopfy-invoice-table-list h-10">
                                                    ...
                                                    <div className="invenShopfy-invoice-table-price"></div>
                                                    <div className="invenShopfy-invoice-table-qty"></div>
                                                    <div className="invenShopfy-invoice-table-tax"></div>
                                                    <div className="invenShopfy-invoice-table-discount"></div>
                                                    <div className="invenShopfy-invoice-table-total border-s border-solid border-gray-borderThree">
                                                        <span>-0.00</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="invenShopfy-invoice-popup-address pt-7 pb-1 mb-12">
                                        <div className="invenShopfy-invoice-popup-address-inner text-start">
                                            <ul>
